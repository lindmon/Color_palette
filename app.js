//GLOBAL SELECTORS AND VARAIBLES
...
//Implement Save to palette and LOCAL STORAGE STORAGE STUFF
...
function savePalette(e){
    ...
    //clear the input after saving the pallete
    saveInput.value = '';
    ...
    // clearBtn.classList.add('clear-palette-btn');
    // clearBtn.innerText = "Clear";
    // clearBtn.addEventListener('click', clearLocalStorage);
    // const libraryPopup = document.querySelector(".library-popup");
    // libraryPopup.appendChild(clearBtn);
